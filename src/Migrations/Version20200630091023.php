 ...
 */
final class Version20200630091023 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles INT NOT NULL, DROP username, DROP password, CHANGE id id INT NOT NULL, CHANGE email email VARCHAR(11) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`');
    }
}
