 ...
 */
final class Version20200630090838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD password VARCHAR(255) NOT NULL, DROP roles, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles INT NOT NULL, DROP password, CHANGE id id INT NOT NULL');
    }
}
